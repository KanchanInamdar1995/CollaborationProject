myModule.controller("ForumController",function($scope,$http,$rootScope,$location)
		{	
			...
			{	console.log("Add fn");
				$http.post('http://localhost:1567/SocialHubMiddleware/addForum',$scope.forum)
			...
			{
				console.log("Show fn");
				$http.get('http://localhost:1567/SocialHubMiddleware/listForums')
				.then(function(response)
				{
			...
			{
				$http.get('http://localhost:1567/SocialHubMiddleware/approveForum/'+forumId)
				.then(function(response)
				{
			...
			{
				$http.get('http://localhost:1567/SocialHubMiddleware/rejectForum/'+forumId)
				.then(function(response)
				{
			...
			$scope.insertForumComment=function()
			{
				...
				$http.post('http://localhost:1567/SocialHubMiddleware/insertForumComment',$scope.forumComment)
				.then(function(response)
				{
